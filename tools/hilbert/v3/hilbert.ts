...
// スタックに保存する「タスク」の型定義
type Task =
  | { type: "command"; value: HilbertCommand }
  | { type: "expand"; rule: RuleType; depth: number };

/**
 * 厳密にスタックを維持し続ける、無限ヒルベルト生成（完全ループ版）
 */
export function* generateInfiniteHilbertPureLoop(): Generator<
  HilbertCommand,
  void,
  unknown
> {
...
// npx tsc --ignoreConfig tools/hilbert/v3/hilbert.ts
