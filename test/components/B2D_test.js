...
Deno.test("B2D set read", () => {
    const x = new B2D();
    x.set();
    assertEquals(x.read(), 1);
});

Deno.test("B2D set read twice", () => {
    const x = new B2D();
    x.set();
    assertEquals(x.read(), 1);
    assertEquals(x.read(), 0);
...
Deno.test("B2D incB2DX read set", () => {
    const x = new B2D();
    x.incB2DX();
    x.incB2DY();
    assertEquals(x.read(), 0);
